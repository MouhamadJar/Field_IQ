...
class EditInterviewDetailsDoctorScreen extends GetView<DoctorInterviewDetailsEditController> {
  final DataInterview dataInterview;
   const EditInterviewDetailsDoctorScreen({Key? key, required this.dataInterview}) : super(key: key);
                    ...
                    Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomRowTime(
                            ...
                            onTap: () async {
                              TimeOfDay? pickedTime = await showTimePicker(
                                  context: Get.context!, initialTime: controller
                                  .timeSelected.value, helpText: 'Start Time'.tr,
                          ...
                          CustomRowInterview(hintText: dataInterview.duration, myController: controller.duration, text: 'Duration'.tr,),
                          const CustomRowInterviewType(),
                          CustomRowInterview(hintText: dataInterview.price.toString(), myController: controller.charges, text: 'Charges'.tr, isNumber: true,),
                         // CustomRowInterview(hintText: 'Sellsmen Number'.tr, myController: controller.sellsmenNumber, text: 'Sellsmen Number'.tr, isNumber: true,),
                          Padding(
                            ...
                            child: CustomButton(text: 'Save Changes'.tr, onTap: (){
                              controller.startTime.text = dataInterview.time;
                                  controller.editInterview(dataInterview.dayId, dataInterview.appointmentId, dataInterview.time, dataInterview.duration, dataInterview.price.toString());
                            },),
                          ),
